...
def checked(cls):
    ...
    methods = (__init__, __setattr__, __repr__, get_fields, wrong_fields)
    methods = {func.__name__: func for func in methods}
    for name, method in methods.items():
        setattr(cls, name, method)

    for name, constructor in cls.get_fields().items():
